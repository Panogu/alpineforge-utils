...
// Enqueue the style-utils.css in the frontend
function alps_utils_enqueue_frontend_styles() {
    wp_enqueue_style(
        'alps-utils-frontend-styles',
        plugins_url( 'assets/css/style-utils.css', __FILE__ ),
        array(),
